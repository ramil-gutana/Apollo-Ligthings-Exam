            ...
            <div class="col-md-10">
                <div class="text-center">
                    ...
                    >
                        ...
                        <use xlink:href="#Dpath" fill="none" />

                        <text font-family="Verdana" font-size="21">
                            <textPath xlink:href="#Dpath">
                                {{ this.text }}
                            </textPath>
                        </text>
                    </svg>
...
export default {
    ...
    methods: {
        getAllBreakdowns() {
            axios.get("http://127.0.0.1:8000/breakdowns").then(response => {
                this.text = response.data.values;
            });
        }
    }
};
